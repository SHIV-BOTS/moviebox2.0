...
MULTI_FSUB = [int(channel_id) for channel_id in environ.get('MULTI_FSUB', '-1001957497326 -1002360481945').split() if re.match(r'^-?\d+$', channel_id)]  # Channel for force sub (make sure bot is admin)

MAGIC_FORCE_SUB = {
    -1001957497326: "normal",
    -1002360481945: "request"
}
